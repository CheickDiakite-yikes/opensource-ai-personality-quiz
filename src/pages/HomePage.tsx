  ...
  return (
    <PageTransition>
      <div className="relative overflow-hidden bg-ghibli-gradient">
        {/* Hero section with animated Ghibli-style scene - Reduced padding at bottom */}
        <section className="relative">
          <GhibliHeroAnimation />
          
          {/* Call to action buttons - Positioned closer to the animation */}
          <div className="container mx-auto px-4 -mt-28 sm:-mt-24 relative z-10">
        ...
        <div id="features" className="mt-4 sm:mt-0">
          <FeatureSection />
        </div>
