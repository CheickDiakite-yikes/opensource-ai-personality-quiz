...
const ProfilePage: React.FC = () => {
  ...
  return (
    <div className="container max-w-full sm:max-w-2xl md:max-w-3xl lg:max-w-4xl mx-auto py-4 md:py-8 px-0 sm:px-3 md:px-4 min-h-screen overflow-x-hidden">
      <div className="px-3">
        <Button 
          variant="ghost" 
      ...
      <div className={`space-y-4 ${isMobile ? 'px-3' : 'space-y-6 md:space-y-8'} overflow-x-hidden`}>
