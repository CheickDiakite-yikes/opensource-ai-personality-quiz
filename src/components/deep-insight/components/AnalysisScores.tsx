      ...
      <Card className="bg-gradient-to-br from-blue-950/90 to-indigo-950/90 border-blue-900/50">
        ...
        <CardContent>
          <div className="space-y-4">
            ...
            <Progress value={intelligenceScore || 0} className="h-2 bg-blue-950" indicatorClassName="bg-blue-400" />
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="bg-gradient-to-br from-rose-950/90 to-pink-950/90 border-rose-900/50">
        ...
        <CardContent>
          <div className="space-y-4">
            ...
            <Progress value={emotionalIntelligenceScore || 0} className="h-2 bg-rose-950" indicatorClassName="bg-rose-400" />
          </div>
        </CardContent>
      </Card>
