    ...
    <div className="relative h-[500px] md:h-[600px] overflow-hidden rounded-b-3xl">
      ...
      {birds.map((bird) => (
        ...
        >
          <svg width={bird.size} height={bird.size / 2} viewBox="0 0 30 15" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path 
              d="M5,5 Q15,0 15,7.5 Q15,15 25,10" 
              stroke="black" 
              strokeWidth="2"
              fill="none"
            />
            <path 
              d="M15,7.5 Q15,0 25,5" 
              stroke="black" 
              strokeWidth="2"
              fill="none"
            />
      ...
      {leaves.map((leaf) => (
        ...
        >
          <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path 
              d="M50,0 C70,25 100,50 50,100 C0,50 30,25 50,0 Z" 
              fill="#66bb6a" 
              opacity="0.8" 
            />
          </svg>
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        ...
        >
          ...
          />
          <motion.h1 
            className="text-4xl md:text-6xl font-serif text-foreground mb-6 drop-shadow-md"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          <motion.p 
            className="text-xl text-foreground/90 mb-8 drop-shadow-sm"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
