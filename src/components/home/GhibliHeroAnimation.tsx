...
const GhibliHeroAnimation: React.FC = () => {
  ...
  // Generate clouds
  const clouds = [
    { left: '10%', top: '20%', width: 120, delay: 0, duration: 120 },
    { left: '5%', top: '40%', width: 100, delay: 15, duration: 150 },
    { left: '15%', top: '60%', width: 80, delay: 30, duration: 100 },
    { left: '-5%', top: '70%', width: 140, delay: 5, duration: 140 },
    { left: '20%', top: '10%', width: 90, delay: 25, duration: 130 }
  ];
  ...
  return (
    <div className="relative h-[450px] md:h-[550px] overflow-hidden rounded-b-3xl">
      {/* Sky background */}
      ...
      <motion.div 
        ...
        animate={{ opacity: mounted ? 0.9 : 0, y: 0 }}
        transition={{ duration: 2, delay: 0.5 }}
        className="absolute top-[15%] right-[15%] h-20 w-20 rounded-full bg-yellow-200"
        style={{ boxShadow: '0 0 40px 10px rgba(254, 240, 138, 0.8)' }}
      />
      ...
      {clouds.map((cloud, index) => (
        <motion.div
          ...
          animate={{ x: '100vw', opacity: mounted ? 0.9 : 0 }}
          transition={{
            x: {
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        ...
        >
          ...
          <motion.h1 
            ...
            className="text-4xl md:text-6xl font-serif mb-4 drop-shadow-md text-slate-50"
          >
          ...
          <motion.p 
            ...
            className="text-lg mb-5 drop-shadow-sm text-orange-900"
          >
          ...
          {/* Brain logo added as a decorative element */}
          <motion.img
            src="/lovable-uploads/c743e847-9cf0-48e3-ae0a-39009ea9f27d.png"
            alt="Brain Logo"
            className="h-32 w-auto mx-auto -mb-6 drop-shadow-md"
