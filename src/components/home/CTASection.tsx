...
const CTASection: React.FC<CTASectionProps> = ({
  ...
  return <div className="bg-gradient-to-r from-primary/10 to-blue-400/10 py-20 relative z-10">
      <div className="container max-w-4xl mx-auto px-4 text-center">
        ...
        margin: "-100px"
          ...
          <Button size="lg" className="px-10 py-6 h-auto text-lg rounded-full shadow-lg" onClick={onAction}>
