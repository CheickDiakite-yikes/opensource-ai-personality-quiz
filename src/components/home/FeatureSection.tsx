...
const FeatureSection: React.FC = () => {
  ...
  return <div id="features" className="py-20 relative z-10 bg-emerald-100">
      <div className="container max-w-6xl mx-auto px-4">
        ...
        margin: "-100px"
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-orange-400">How Our Personality Test Works</h2>
          <p className="text-lg max-w-2xl mx-auto text-orange-300">
        ...
        <div className="mt-16 text-center">
          ...
          margin: "-100px"
            ...
            <Button size="lg" className="px-8 py-6 h-auto rounded-full flex items-center justify-center" onClick={() => navigate("/assessment")} aria-label="Start personality assessment">
